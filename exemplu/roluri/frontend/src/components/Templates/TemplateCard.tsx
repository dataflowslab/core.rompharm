...
interface TemplateCardProps {
  ...
  onEditName: (code: string) => void;
  getBadgeColor: (type: string) => string;
}

export function TemplateCard({ template, onEdit, onDelete, onEditName, getBadgeColor }: TemplateCardProps) {
          ...
          <div style={{ flex: 1 }}>
            <Group gap="xs">
              ...
              <Button
                ...
                onClick={() => onEditName(template.code)}
